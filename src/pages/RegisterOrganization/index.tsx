...
const RegisterOrganization = () => {
  ...
  const [SelectedFilterDay, setSelectedFilterDay] = useState("30" as any);
  const [SelectedDayCount, setSelectedDayCount] = useState("30" as any);
  ...
  const HandleFilterInputChange = ({ target = {} }: any) => {
  ...
  const GetOrgList = () => {
    let cityArray: any = [{ value: "", label: "Select Organization" }];
  ...
  const HandleGo = () => {
    if (!!SelectedOrganization.value) {
      let value: any = {};
      if (!!RegOrgConfigData.data.data && RegOrgConfigData.data.data.length) {
        value = RegOrgConfigData.data.data.find(
          (i) => i.id === SelectedOrganization.value
        );
      }
  ...
  const HandleCustomButtonChange = ({ target = {} }: any) => {
    let { value } = target;
    if (value === 30) {
      setSelectedDayCount(30);
      setSelectedFilterDay("30");
      ...
      <div className="body-usable-container">
        <div className="row">
          ...
          <div className="col-12 col-xl-6 FJCEAIC mt-4 mt-xl-0 aside-select">
            <div className="FAIC">
              <span className="small d-none d-sm-block">
              ...
              >
                ...
                <div
                  ...
                  className={`day-filter-popup${
                    !!IsOpenFilterDropdown ? " d-block" : " d-none"
                  }`}
                >
                  <div className="my-2">
                    <input
                  ...
                  <div className="my-2">
                    <input
                      ...
                      onChange={(event) => HandleFilterInputChange(event)}
                      value={"Custom"}
                      checked={SelectedFilterDay === "Custom"}
                      id="Custom"
                      name="SelectedDays"
                    />{" "}
                  ...
                  <div className="my-2">
                    <input
                      ...
                      onChange={(event) => HandleFilterInputChange(event)}
                      value={"No Expiry"}
                      checked={SelectedFilterDay === "No Expiry"}
                      id="No Expiry"
                      name="SelectedDays"
                    />{" "}
              ...
              {!!SelectedFilterDay && SelectedFilterDay === "Custom" ? (
                <input
                  type="number"
                  value={SelectedDayCount}
                  onChange={(event) => HandleCustomButtonChange(event)}
                  style={{ width: "80px" }}
                />
              ) : (
                <></>
        ...
        <div className="tabel-container">
          <table className="com-table">
            ...
            <tbody>
              {!!RegOrgConfigData.data.data &&
              RegOrgConfigData.data.data.length ? (
